...
with DAG(
    ...
    def extract_csv(**kwargs):
        ...
        DF_UK.to_csv('/home/airflow/data/initial.csv')
    ...
    def generate_plot_and_data(**kwargs):
        ...
        import matplotlib
        DF_UK = pd.read_csv('/home/airflow/data/initial.csv')
        font = {'weight' : 'bold',
                'size'   : 18}
        ...
        DF_UK_u_2.to_csv('/home/airflow/data/uk_scoring_report_NotScaled.csv')
    ...
    def to_db(**kwargs):
        ...
        DF_uk_u_2 = pd.read_csv('/home/airflow/data/uk_scoring_report_NotScaled.csv')
